...
class Search():
    ...
    def couduct_search(self, area_num, area_array, effectiveness_prob):
...
def main():
    ...
    while True:
        ...
        if choice == "0":
            ...
            results_1, coords_1 = app.couduct_search(1, app.sa1, app.sep1)
            results_2, coords_2 = app.couduct_search(1, app.sa1, app.sep1)
            app.sep1 = (len(set(coords_1 + coords_2))) / (len(app.sa1)**2)
            app.sep2 = 0
            app.sep3 = 0
        elif choice == "2":
            results_1, coords_1 = app.couduct_search(2, app.sa2, app.sep2)
            results_2, coords_2 = app.couduct_search(2, app.sa2, app.sep2)
            app.sep1 = 0
            app.sep2 = (len(set(coords_1 + coords_2))) / (len(app.sa2)**2)
            app.sep3 = 0
        elif choice == "3":
            results_1, coords_1 = app.couduct_search(3, app.sa3, app.sep3)
            results_2, coords_2 = app.couduct_search(3, app.sa3, app.sep3)
            app.sep1 = 0
            app.sep2 = 0
